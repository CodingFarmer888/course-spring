...
public class ProductController {
	...
	public String uploadFile(@ModelAttribute ProductVo productVo) throws IOException {
		productService.addProduct(productVo);
		return "File uploaded successfully: " + productVo.getUploadFile().getOriginalFilename();
	}
